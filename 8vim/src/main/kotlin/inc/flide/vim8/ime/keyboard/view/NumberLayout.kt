...
fun NumberLayout() {
    val keyboard = Keyboard(
        arrayOf(
            arrayOf(
                Key("َ".toKeyboardAction()),
                Key("ِ".toKeyboardAction()),
                Key("ُ".toKeyboardAction()),
                Key("ّ".toKeyboardAction()),
            ...
            arrayOf(
                Key("ْ".toKeyboardAction()),
                Key("ً".toKeyboardAction()),
                Key("ٍ".toKeyboardAction()),
                Key("ٌ".toKeyboardAction()),
                Key(
            ...
            arrayOf(
                Key("ٰ".toKeyboardAction()),
                Key("ـ".toKeyboardAction()),
                Key("ء".toKeyboardAction()),
                Key(")".toKeyboardAction()),
                Key(
